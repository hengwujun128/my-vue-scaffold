<script lang="ts" setup>
  ...
  function scrollToPos(val: number) {
    ...
    if (scrollContainer.value.scrollTop === val) return
...
<template>
  <div ref="scrollContainer" class="scroll-container" @scroll.passive="handleScroll">
    <ul class="scroll-container__list" :style="containerStyle">
      <template v-for="(item, index) in viewList" :key="item[rowKey]">
        <li :data-index="index" class="scroll-container__item" :style="itemStyle">
